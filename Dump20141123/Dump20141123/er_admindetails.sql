...
CREATE TABLE `admindetails` (
  ...
  CONSTRAINT `admindetails_ibfk_1` FOREIGN KEY (`username`) REFERENCES `login` (`username`)
...
INSERT INTO `admindetails` VALUES ('Administrator','EasyResearch','easyresearchcms@gmail.com','root');
